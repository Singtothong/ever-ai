...
from apps import diabetes, hypertension, hyperlipidaemia,predictivehealthapp,healthpredictionapp,diseasepredictionapp,drugapp,home,outbreakforcastingapp,pakinsondrawingsapp,druginterctionapp,ocr,xray,sleep,healthsummary,patho,covid,ekyc,map,speeh,cctv,listofproduct
...
app.add_app('--[List of Products]--', listofproduct.app)
...
app.add_app('CCTV Detection', cctv.app)
